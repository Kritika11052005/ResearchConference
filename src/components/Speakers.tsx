...
const Speakers = () => {
  ...
  const SpeakerSection = ({ title, speakers, bgColor }: { title: string; speakers: Speaker[]; bgColor: string }) => (
  ...
  return (
    <section id="speakers" className="py-20">
      ...
      <SpeakerSection 
        ...
        bgColor="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-gray-800 dark:to-gray-900"
      />
